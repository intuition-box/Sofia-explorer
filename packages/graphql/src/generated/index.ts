...
export const GetAllActivityDocument = `
  ...
  events(
    ...
    where: {type: {_eq: "Deposited"}, deposit: {sender_id: {_eq: $proxy}, assets_after_fees: {_neq: "0"}}}
  ) {
    id
    created_at
    deposit {
