...
export const GetProxyDepositDaysDocument = `
  ...
  deposits(
    where: {sender_id: {_ilike: $senderId}, term_id: {_eq: $termId}, assets_after_fees: {_neq: "0"}}
    order_by: {created_at: desc}
  ) {
    receiver_id
    created_at
